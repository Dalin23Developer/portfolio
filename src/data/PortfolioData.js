...
export const skillsData = [
  {
    title: "Laravel",
    desc: "Build robust web applications using the MVC architecture, Eloquent ORM, Blade templating, routing, and built-in authentication and security features.",
    icon: <SiLaravel />,
    star: 5,
  },
  {
  ...
  {
    title: "Javascript",
    desc: "Create interactive and dynamic web experiences with the versatile scripting language.",
    icon: <SiJavascript />,
    star: 5,
  },
  {
    title: "Typescript",
    desc: "Enhance JavaScript with static types, making code more understandable and reliable.",
    icon: <SiTypescript />,
    star: 5,
  },
  {
    title: "HTML 5",
    desc: "Structure web content beautifully with the latest version of HyperText Markup Language.",
    icon: <SiHtml5 />,
    star: 4,
  },
  {
    title: "CSS 3",
    desc: "Style web pages creatively with the latest iteration of Cascading Style Sheets.",
    icon: <SiCss3 />,
    star: 4,
  },
  {
    title: "Bootstrap",
    desc: "Quickly create responsive and appealing web designs using a popular CSS framework.",
    icon: <SiBootstrap />,
    star: 2,
  },
  {
    title: "MySQL",
    desc: "Manage and organize relational databases efficiently for data-driven applications.",
    icon: <SiMysql />,
    star: 2,
  },
];
...
export const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "lin280454@gmail.com",
    href: "mailto:lin280454@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+855 71 508 7086",
    href: "tel:+855715087086",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Khan Pou Senchey, Phnom Penh, Cambodia",
    href: "https://www.google.com/maps/search/?api=1&query=Khan+Pou+Senchey,+Phnom+Penh,+Cambodia",
  },
];
...
export const projectsDetail = [
  {
    title: "",
    desc: `For my final academic project, I developed Viavi Real Estate, a comprehensive property management system designed to solve real-world challenges in the housing market. My goal was to build a professional-grade platform that handles complex data—such as property types, locations, and pricing—while maintaining a clean, modern user interface.
           As a full-stack developer, I chose Laravel for the backend due to its robust security and React.js for the frontend to create a fast, single-page application (SPA) experience. I successfully designed and implemented a relational database to manage 7 distinct property categories (Residential, Office, Industrial, etc.) and built a functional Advanced Search Filter that mimics professional real estate sites.
           This project was a significant milestone in my education, allowing me to master the integration of API-driven development. I went beyond basic requirements by building a fully operational Admin Dashboard that tracks site statistics and revenue, demonstrating my ability to handle both user-facing features and backend business logic.`,
    images: {
